...
video_put_ags.add_argument("name", type=str, help="Name of video is required", required=True)
video_put_ags.add_argument("views", type=int, help="Views of video is required", required=True)
video_put_ags.add_argument("likes", type=int, help="Likes of video is required", required=True)
